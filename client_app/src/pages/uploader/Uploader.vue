<script>
import handleErrorMixin from "../../components/mixins/HandleErrorMixin";
        ...
        <table class="table-auto w-full" v-if="requestList.length">
          ...
          <tbody>
            <tr v-for="x in requestList">
              <td>
                <span
                  class="bg-green-700 hover:bg-green-800 inline-block whitespace-nowrap rounded-full px-[0.65em] pb-[0.25em] pt-[0.35em] text-center align-baseline text-[0.75em] font-bold leading-none"
                >
                  {{ x.retime }}
                </span>
                {{ x.abtime }}
              ...
              <td>
                <button
                  type="button"
                  class="btn btn-red group relative duration-300"
                  @click="deleteRequest(x)"
                >
                  <svg
                    v-if="x.isDeleting"
                    aria-hidden="true"
                ...
                <button
                  type="button"
                  class="btn btn-blue"
                  @click="copyDirToClipboard($event, x.timestamp)"
                  title="sshfs에서 열기"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
